...
const Data = () => {
  return (
     <div className="home__data">
        <h1 className="home__title">Anand Agrahari
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className='home__description'>I'm creative designer based in New Delhi, and I'm very passinate and dedicated to my work.</p>
